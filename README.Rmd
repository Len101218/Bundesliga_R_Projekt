...
Die ausgegebenen p-Werte sind ziemlich klein und in der Simulation sogar 0. Es kommt also fast nie vor, dass ein Sample einen grösseren Wert als die gemessene Statistik($\approx 56$) evaluiert. Deshalb ist der maximale Fehler 1. Art ziemlich klein, und die Nullhypothese kann mit jedem vernünftigen Signifikantsniveau verworfen werden.
